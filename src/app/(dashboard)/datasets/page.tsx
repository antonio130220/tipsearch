  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {[1, 2, 3].map((i) => (
          <HoverGlow key={i} color="indigo">
            <div className="group rounded-lg border bg-white p-6 transition-colors cursor-pointer shadow-sm hover:border-zinc-300">
              ...
              <h3 className="font-semibold text-zinc-900 break-words">Dataset de Preços de Imóveis {2024 - i}</h3>
              <p className="mt-2 text-sm text-zinc-500 truncate">Formato CSV • 1.2 GB</p>
            </div>
          </HoverGlow>
        ))}
      </div>
